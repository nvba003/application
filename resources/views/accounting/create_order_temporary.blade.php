...
<div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex flex-row items-right w-1/2">
        ...
        <div class="flex items-center justify-between mt-2">
            <button type="submit" class="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-green-700 focus:outline-none focus:shadow-outline">Gửi Đơn Hàng</button>
