...
class CreateOrderReturnTemporariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('order_return_temporaries', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('order_return_temporaries');
    }
}
